...
public class ImageTypeServletTest {
  ...
  private ImageTypeService imageTypeService = mock(ImageTypeServiceImpl.class);
  ...
  public void testHandleGet() throws Exception {
    ...
    ImageTypeService imageTypeService = mock(ImageTypeServiceImpl.class);
    when(req.getRequestURI()).thenReturn("/imageTypes/imageTypeName");
    when(imageTypeServlet.imageTypeService.findImageTypeWithOwnershipsByName(anyString())).thenReturn(imageTypeDTO);
