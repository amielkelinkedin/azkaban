...
public class ImageTypeServiceImpl implements ImageTypeService {
  ...
  public List<ImageTypeDTO> getAllImageTypesWithOwnerships() {
    ...
    List<ImageTypeDTO> imageTypeDTOs =
        imageTypes.stream().map(i -> this.converter.convertToApiResponseDTO(i)).collect(Collectors.toList());
  ...
  @Override
  public ImageTypeDTO findImageTypeWithOwnershipsByName(String imageTypeName) throws ImageMgmtException {
